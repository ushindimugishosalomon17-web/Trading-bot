...
def main():
    ...
    buy_signal = (last_st == 1 and prev_rsi <= 30 and last_rsi > 30 and
                  prev_macd <= prev_sig and last_macd > last_sig)
    sell_signal = (last_st == -1 and prev_rsi >= 70 and last_rsi < 70 and
                   prev_macd >= prev_sig and last_macd < last_sig)
